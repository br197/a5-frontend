...
const emit = defineEmits(["getNearbyUsers"]);
...
<template>
  <form @submit.prevent="emit('getNearbyUsers', city, selectedState)" class="pure-form">
    <fieldset>
      <legend>Find People Nearby Me</legend>
      <input id="city" name="city" v-model="city" placeholder="Enter your current city" required />
      <div>
        <label for="states">Enter your state:</label>
