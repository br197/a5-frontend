...
<template>
  ...
  <form @submit.prevent="updateUsername" class="pure-form">
    <fieldset>
      ...
      <button type="submit" class="pure-button pure-button-primary button-color">Update username</button>
    </fieldset>
  </form>
  ...
  <form @submit.prevent="updatePassword" class="pure-form">
    <fieldset>
      ...
      <button type="submit" class="pure-button pure-button-primary button-color">Update password</button>
    </fieldset>
  </form>
</template>
